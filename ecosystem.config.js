module.exports = {
	...
	deploy: {
		development: {
			...
			"post-deploy": "export PATH=$PATH:/usr/local/bin && cd server && npm install && cd .. && ls -a && pm2 startOrRestart ecosystem.config.js --env development"
		},
		production: {
			key: "/Users/tobias/.ssh/id_rsa",
			user: "macmini",
